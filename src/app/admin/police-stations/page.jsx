...
function Page() {
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: (row) =>
        row.filename ? (
          <a href={`http://43.204.148.171:7000/uploads/${row.filename}`} target="_blank" download={row.name}>
            {/* <FaDownload className="h-10 w-10 p-3 text-white rounded-full bg-yellow-300" /> */}
            <img src={`http://43.204.148.171:7000/uploads/${row.filename}`}/>
          </a>
        ) : (
          <FaDownload className="h-10 w-10 p-3 text-white rounded-full bg-yellow-300" />
        ),
    ...
    },
    {
      ...
      cell: (row) =>
        row.filename2 ? (
          <a href={`http://43.204.148.171:7000/uploads/${row.filename2}`} target="_blank" download={row.name}>
            {/* <FaDownload className="h-10 w-10 p-3 text-white rounded-full bg-yellow-300" /> */}
            <img src={`http://43.204.148.171:7000/uploads/${row.filename2}`}/>
          </a>
        ) : (
          <FaDownload className="h-10 w-10 p-3 text-white rounded-full bg-yellow-300" />
        ),
    ...
    },
    {
      ...
      cell: (row) =>
        row.filename3 ? (
          <a href={`http://43.204.148.171:7000/uploads/${row.filename3}`} target="_blank" download={row.name}>
            {/* <FaDownload className="h-10 w-10 p-3 text-white rounded-full bg-yellow-300" /> */}
            <img src={`http://43.204.148.171:7000/uploads/${row.filename3}`}/>
          </a>
        ) : (
          <FaDownload className="h-10 w-10 p-3 text-white rounded-full bg-yellow-300" />
        ),
