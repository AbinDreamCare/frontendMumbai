    ...
    <div className="w-full">
      ...
      <div className="bg-[#D2D2D2] h-auto ">
        <div className="pt-20 text-center">
          <h1 title={t('passport_status')} className="mx-20 py-10 text-[24px] md:text-4xl font-extrabold md:justify-center md:flex text-[#15233E]">
          {t('passport_status')}
          </h1>
        ...
        <div className="text-[#15233E] md:mx-14">
          ...
          <div className="rounded-xl">
            <div className="p-5 mt-8 lg:mt-10">
              <p title={t('passport_2')} className="text-2xl font-bold text-center">
              {t('passport_2')}
              </p>
              <p title={t('passport_3')} className="md:text-xl">
          ...
          <div className=" rounded-xl">
            <div className="p-5 mt-8 lg:mt-10">
              <p title={t('passport_5')} className="text-2xl font-bold text-center">
                {t('passport_5')}
              </p>
              <p title={t('passport_6')} className=" md:text-xl">
              ...
              <p title={t('passport_8')} className=" md:text-xl">
              ...
              <p title={t('passport_10')} className=" md:text-xl">
          ...
          <div className=" rounded-xl">
            <div className="p-5 mt-8 lg:mt-10">
              <p title={t('passport_12')} className="text-2xl font-bold text-center">
             {t('passport_12')}
              </p>
              <p title={t('passport_13')} className=" md:text-xl">
              {t('passport_13')}
              </p>
            </div>
          </div>
          <div className=" rounded-xl">
            <div className="p-5 mt-8 lg:mt-10">
              <p className="text-2xl font-bold text-center" title={t('passport_14')}>{t('passport_14')}</p>
              <p title={t('passport_15')} className=" md:text-xl">
          ...
          <div className=" rounded-xl">
            <div className="p-5 mt-8 lg:mt-10">
              <p title={t('passport_17')} className="text-xl font-bold underline">
              {t('passport_17')}
              </p>
